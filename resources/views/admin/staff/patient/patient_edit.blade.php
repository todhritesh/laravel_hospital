                ...
                <div class="card-body">
                    <form action="{{route('patient.update',['id'=>$patient->id])}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="problem" value="{{$patient->pro->problem}}" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label for="">Problem Description</label>
                            <textarea name="problem_descr" class="form-control" cols="30" rows="5">{{$patient->pro->problem_descr}}</textarea>
                        </div>
                        {{-- <div class="mb-3">
